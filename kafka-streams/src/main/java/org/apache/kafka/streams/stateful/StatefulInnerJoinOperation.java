...
public class StatefulInnerJoinOperation {
    ...
    private final static String APP_ID = "stateful_inner_join_operation";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        userKs.join(addressKs, (left, right) -> left + "-----" + right, JoinWindows.of(Duration.ofMillis(1)),
                        StreamJoined.with(Serdes.String(), Serdes.String(), Serdes.String()))
                .print(Printed.<String, String>toSysOut().withLabel("user-info-join-address"));
        //3. create topology
