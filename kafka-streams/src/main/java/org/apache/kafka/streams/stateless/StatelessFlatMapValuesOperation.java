...
public class StatelessFlatMapValuesOperation {
    ...
    private final static String APP_ID = "stateless_flatmapValues_streams_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        kStream.flatMapValues(v->Arrays.stream(v.split("\\s+"))
                        .map(e->e.toUpperCase()).collect(Collectors.toList()),Named.as("flatMapValues-processor"))
                .print(Printed.<String, String>toSysOut().withLabel("flatMapValues-operation"));
        //3. create topology
