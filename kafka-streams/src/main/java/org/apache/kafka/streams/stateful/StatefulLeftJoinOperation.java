 ...
 * @author arthur
 */
public class StatefulLeftJoinOperation {
    //0. define variable
    private final static Logger LOG = LoggerFactory.getLogger(StatefulLeftJoinOperation.class);
    private final static String APP_ID = "stateful_left_join_operation";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        userKs.leftJoin(addressKs, (left, right) -> left + "-----" + right, JoinWindows.of(Duration.ofMillis(1)),
