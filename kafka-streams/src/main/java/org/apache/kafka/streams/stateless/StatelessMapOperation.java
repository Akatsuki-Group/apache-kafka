 ...
 * @author arthur
 */
public class StatelessMapOperation {
    //0. define variable
    private final static Logger LOG= LoggerFactory.getLogger(FirstStreamsApplication.class);
    private final static String APP_ID="stateless_map_streams_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        KStream<String, Integer> kStream1 = kStream.map((nokey, v) -> KeyValue.pair(v, v.length()), Named.as("map-transform-processor"));
        kStream1.print(Printed.<String,Integer>toSysOut().withLabel("map-operation"));
        //3. create topology
