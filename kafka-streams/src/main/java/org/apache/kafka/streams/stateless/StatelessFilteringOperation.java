...
public class StatelessFilteringOperation {
    ...
    private final static String APP_ID="stateless_filter_streams_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        kStream.filter((k, v) -> v.contains("kafka"), Named.as("filter-processor"))
                .print(Printed.<String,String>toSysOut().withLabel("filter-operation"));
        kStream.filterNot((k, v) -> v.contains("kafka"), Named.as("filterNot-processor"))
                .print(Printed.<String,String>toSysOut().withLabel("filterNot-operation"));
        //3. create topology
